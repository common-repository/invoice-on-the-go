...
wp_enqueue_script('rniotg-bundle-main',RedNaoInvoiceOnTheGo::$URL.'js/angular/dist/settings_main.bundle.js',array('rniotg-bundle-vendor'),RedNaoInvoiceOnTheGo::$FILE_VERSION,true);
...
wp_localize_script('rniotg-bundle-main','rnparams',array(
        ...
        'settings'=>$settings,
        'originalInvoiceNumber'=>$settings->NextInvoiceNumber,
